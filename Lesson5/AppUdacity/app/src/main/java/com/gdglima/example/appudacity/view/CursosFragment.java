package com.gdglima.example.appudacity.view;
...
public class CursosFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        cursoEntities.add(new CursoEntity("Matemática","https://campus.com/matematica"));
        cursoEntities.add(new CursoEntity("Filosofia","https://campus.com/matematica"));
        cursoEntities.add(new CursoEntity("Física","https://campus.com/matematica"));
